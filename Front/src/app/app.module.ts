...
@NgModule({ declarations: [
    ...
    bootstrap: [AppComponent], imports: [DragDropModule,
        ...
        AppRoutingModule], providers: [KeycloakService, ResizeService, SortService, FilterService, SelectionService, ReorderService,
        EditService, DayMarkersService, ToolbarService, provideHttpClient(withInterceptorsFromDi())] })
